...
function Menu() {
  ...
  return (
    <>
      <Alerta mensaje={mensaje_alerta}></Alerta>
          ...
          {visualizar ? (
            <>
              ...
              <button
                ...
                title="Copiar Filas"
                style={{ bottom: "260px" }}
                className="fixed bottom-20 right-4 z-50 bg-yellow-600 text-white p-3 rounded-full shadow-md hover:bg-yellow-700 transition flex items-center justify-center"
              >
                <i
                  className={`fas ${
                    !personalizar &&
              ...
              <button
                ...
                style={{ bottom: "320px" }}
                className="fixed bottom-20 right-4 z-50 bg-red-600 text-white p-3 rounded-full shadow-md hover:bg-red-700 transition flex items-center justify-center"
              >
                <i
                  className={`fas ${
                    !personalizar &&
              ...
              <button
                ...
                title="Descargar PDF"
                style={{ bottom: "380px" }}
                className="fixed  right-4 z-50 bg-green-500 text-white p-3 rounded-full shadow-md hover:bg-green-600 transition flex items-center justify-center"
              >
